# This code was developed by Saâdaoui and Rabbouch (2024) for performing multiresolution causality analysis 
# between two time series using Variational Mode Decomposition (VMD). 
# 
# If you use this code in your research, please cite it as follows:
# ---------------------------------------------------------------------------------------------
# Saâdaoui, F., & Rabbouch, H. (2024). Multiresolution Granger causality testing 
